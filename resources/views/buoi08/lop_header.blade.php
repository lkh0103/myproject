<div id="header">
			...
			<div class="container-fluid">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Lạc Long Quân, TPHCM</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 093 296 7751</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						<li><a href="{{route('phanloai')}}">Quản lý trang</a></li>
							@if(Auth::check())
		...
		<div class="header-body">
			<div class="container-fluid">
				<div class="pull-left">
					<a href="{{route('trangchu')}}" id="logo"><img src="{{asset('source/assets/dest/images/logo-cake.png')}}" width="200px" alt=""></a>
				</div>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('loai_san_pham')}}">Loại Sản phẩm</a>
							<ul class="sub-menu">
